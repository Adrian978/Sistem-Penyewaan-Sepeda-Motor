...
$query="UPDATE $table_name SET id_pelanggan='$id_pelanggan',nama='$nama',alamat='$alamat',tgl_lahir='$tgl_lahir',nm_motor='$nm_motor',no_telp='$no_telp'WHERE id_pelanggan='$id_pelanggan'";
